    ...
    function deleteById() {
        ...
        if(id) {
            if(confirm("你确认要删除此条记录吗？")) {
                location.href="${ctx}/company/deleteCompany?id="+id;
            }
        }else{
            ...
            <div class="table-box">
                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            <button type="button" class="btn btn-default" title="新建" onclick='location.href="${ctx}/path/addCompany"'><i class="fa fa-file-o"></i> 新建</button>
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${ctx}/path/updateCompany?id=${item.id}"'>编辑</button>
                        </td>
                    </tr>
                    </c:forEach>
                    </tbody>
        ...
        <input type="hidden" name="page" id="page" value="">
         ...
         <div class="box-footer">
             <jsp:include page="../../common/page.jsp">
                 <jsp:param value="${ctx}/company/getCompany" name="pageUrl"/>
             </jsp:include>
         </div>
        <!-- /.box-footer-->
