            ...
            <div class="table-box">
                ...
                <div class="pull-left">
                    <div class="form-group form-inline">
                        <div class="btn-group">
                            <button type="button" class="btn btn-default" title="新建" onclick='location.href="${ctx}/path/addQuestion"'><i class="fa fa-file-o"></i> 新建</button>
...
--%>
                            <button type="button" class="btn btn-default" title="导出题目" onclick=location.href="${ctx}/question/downloadReport"> <i class="fa fa-download"></i>导出题目</button>
                        </div>
                    </div>
                </div>
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                        ...
                        <th class="text-center">
                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${ctx}/path/updateQuestion?id=${o.id}"'>编辑</button>
                            <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${ctx}/questionItem/getQuestionItem?questionId=${o.id}"'>配置选项</button>
        ...
        <div class="box-footer">
            <jsp:include page="../../common/page.jsp">
                <jsp:param value="${ctx}/question/getQuestion" name="pageUrl"/>
            </jsp:include>
        </div>
    </div>
