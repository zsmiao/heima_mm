    ...
    <script type="text/javascript">
        function deleteById(id) {
            ...
            if(confirm("你确认要删除此条记录吗？")) {
                window.location.href="${ctx}/questionItem/deleteQuestionItem?questionId=${questionId}&id="+id;
            }
        }
    </script>
</head>
...
<div id="frameContent" class="content-wrapper" style="margin-left:0px;">
    ...
    <section class="content">
        ...
        <div class="panel panel-default">
            ...
            <form id="editForm" action="${ctx}/questionItem/addOrUpdateQuestionItem" method="post">
                    ...
                    <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                        ...
                        <c:forEach items="${page}" var="o" varStatus="status">
                            <tr class="odd" onmouseover="this.className='highlight'" onmouseout="this.className='odd'" >
                                ...
                                <td>
                                    <button type="button" class="btn bg-olive btn-xs" onclick='location.href="${ctx}/questionItem/toUpdateQuestionItem?questionId=${questionId}&id=${o.id}"'>编辑</button>
