        ...
        <div class="box-body">
            <div class="nav-tabs-custom">
                ...
                <div class="tab-content">
                    <form id="editForm" action="${ctx}/question/addQuestion" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row data-type">
                                ...
                                <div class="col-md-4 data">
                                    <select class="form-control" name="companyId"
                                            onchange="document.getElementById('companyName').value=this.options[this.selectedIndex].value">
                                        <option>请选择</option>
                                ...
                                <div class="col-md-4 data">
                                    <select class="form-control" name="catalogId"
                                            onchange="document.getElementById('catalogName').value=this.options[this.selectedIndex].value">
                                        <option>请选择</option>
