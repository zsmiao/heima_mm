    ...
    <div class="box box-primary">
                ...
                <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                    ...
                    <c:forEach items="${page.list}" var="o"  varStatus="st">
                        <tr>
                            ...
                            <th class="text-center"><button type="button" class="btn bg-olive btn-xs" onclick='location.href="${ctx}/path/updateModule?id=${o.moduleId}"'>编辑</button></th>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
        ...
        <div class="box-footer">
            <jsp:include page="../../common/page.jsp">
                <jsp:param value="${ctx}/module/getModules" name="pageUrl"/>
            </jsp:include>
        </div>
    </div>
</section>
